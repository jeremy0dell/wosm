...
A provider hook is an external provider callback or generated provider hook command. Examples include Worktrunk lifecycle hooks, Codex hooks, OpenCode plugin hooks, and Pi extension callbacks.
...
- Provider setup output still clearly refers to Worktrunk/Codex/OpenCode/Pi hooks.
