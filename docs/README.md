...
- [Client package observer runtime plan](planning/active/client_package_observer_runtime_plan.md) is the active plan for extracting shared rich-client observer synchronization into `packages/client`, and is the prerequisite for Station's live observer-backed WOSM overlay.
