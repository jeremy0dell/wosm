...
**Source baseline:** `docs/planning/historical/wosm_rebuild_tdd_final_v1.md`, `docs/planning/historical/wosm_phased_development_cycle_final_v1.md`, and `docs/planning/active/code_smell_remediation_p1_p2.md`
