// ADAPTED-EXTRACTION from apps/tui/src/components/WorktreeRow/WorktreeRow.tsx
// (see ../../PROVENANCE.md): the pure row-input/marker/metadata functions,
// verbatim bodies, minus the Ink rendering components that surrounded them.
// The OpenTUI view renders the RowGridLayout these produce.
