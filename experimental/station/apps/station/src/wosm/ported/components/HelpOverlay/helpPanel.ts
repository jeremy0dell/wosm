// ADAPTED-EXTRACTION from apps/tui/src/components/HelpOverlay/HelpOverlay.tsx
// (see ../../PROVENANCE.md): the pure panel layout and line generation,
// verbatim bodies. Adaptation: the help content is a parameter — Station
// derives it from the keymap data (wosmKeymap.ts WOSM_HELP_CONTENT, copy
// pinned to upstream's hardcoded list by test) instead of a local constant.
